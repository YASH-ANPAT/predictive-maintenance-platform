...
from app.services.prediction_service import generate_maintenance_recommendation
...
def run_prediction(
    ...
    model = get_model()
    model_features = telemetry_to_model_features(latest_telemetry)
    failure_probability = _extract_failure_probability(model, model_features)
